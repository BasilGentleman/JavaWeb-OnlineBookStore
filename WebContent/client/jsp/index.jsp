...
<!--内容-->
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
         <div class="panel-heading"><h3>销量排行板<small>前八名</small></h3></div>
        	<div class="col-sm-12 col-md-12">
        	<c:forEach items="${booklist}" var="book">
	            ...
	            <%--  <a href="item.do?bid=${book.getBid()}"><img src="${pageContext.request.contextPath}${book.imgurl}" alt="${book.name}"></a> --%>
	                    ...
	                    <div class="caption">
	                        <div>现 价：¥
	                         	<span style="color: #c9302c;font-size: 20px">
									<fmt:formatNumber type="number" value=" ${book.price}" pattern="0.00" maxFractionDigits="2"/>
									</span>
							</div>
